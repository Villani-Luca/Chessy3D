...
\begin{itemize}
    ...
    \item {
        \textbf{Castling rights}: Uppercase letter comes first and indicates castling right for white, followed by lowercased for black, "k" indicates king side is available, "q" means that a player may castle queenside
        \begin{center}
