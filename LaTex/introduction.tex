...
utilizing a pipeline spanning from a chessboard corners detection algorithm to chess-pieces object detection 
...
\begin{itemize}
    ...
    \item Section III describes the chess piece detection pipeline.
