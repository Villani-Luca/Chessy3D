...
\begin{itemize}
    \item Section II presents our proposed methods for detecting chessboard corners and cell boundaries.
    \item Section III describes the chess piece detection pipeline using YOLOv8.
    \item Section IV outlines the procedure for generating FEN annotations from board states.
    \item Section V introduces the method for chess image similarity search.
\end{itemize}
