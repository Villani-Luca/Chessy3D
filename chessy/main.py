...
from chessy.gui.chessboard import ChessBoardWidget
from chessy.gui.datagrid import DataGrid
from chessy.gui.fileuploader import FileUploader
from chessy.gui.retrivaljob import RetrievalJob
from chessy.retrieval.src.commons import zobrist_to_s64
from chessy.retrieval.src.pgsql import Connection, PgGamesRepository
import chessy.chessboard_localization.main as chess_localization
from chessy.retrieval.src.position_embeddings import NaivePositionEmbedder
...
if __name__ == "__main__":
    args = {
        ...
        "object_detection_yolo": r"chesspiece_detection/model.pt",
