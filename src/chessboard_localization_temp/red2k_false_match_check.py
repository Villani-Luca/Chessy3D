...
text_file = folder / "result_false_50.txt"
output_folder = folder / "result_false_check/"
...
def work(chunk: list[tuple[str, int]]):
    ...
    for img_path in image_path:
        ...
        output_image, _, _, _ = chess_localization.auto_chessboard_localization(img, resized)
