...
internal class PgConnectionFactory
{
    static NpgsqlDataSource? _datasource = null;

    public static NpgsqlDataSource CreateConnection(string connectionString)
    {
        if(_datasource == null)
        {
...
public class PgAddParseResultJITCommand : IDisposable
{
    private readonly NpgsqlCommand _command;

    public NpgsqlTransaction? Transaction { get => _command.Transaction; set => _command.Transaction = value; }

    private PgAddParseResultJITCommand(NpgsqlCommand command)
    {
        _command = command;
    }

    public static PgAddParseResultJITCommand Create(NpgsqlConnection connection, NpgsqlTransaction? transaction = null)
    {
        ...
        return new PgAddParseResultJITCommand(command);
    }
